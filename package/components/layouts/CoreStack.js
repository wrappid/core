...
CoreStack.validProps = [
    ...
    types: [
      {
        default: "",
        type: "string",
        validValues: ['column-reverse', 'column', 'row-reverse', 'row' ,`Array<'column-reverse'`, 'column' ,'row-reverse', `'row'>`, 'object'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    types: [
        type: "string",
        { default: "", validValues: "Array<number| string>| number| object| string" },
    ],
  },
