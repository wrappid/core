    ...
    return (
            ...
            >
                ...
                <CoreBox gridProps={{ gridSize: 10 }}>
                    ...
                    {profile?.contact?.email && profile?.contact?.email !== "" && (
                        <RxEmailLink email={profile?.contact?.email} verified={profile?.basic?.emailVerified} />
                    )}

                    {profile?.contact?.phone && profile?.contact?.phone !== "" && (
                        <RxPhoneLink phone={profile?.contact?.phone} verified={profile?.basic?.phoneVerified} />
                    )}
                </CoreBox>
            </CoreGrid>
        ...
        (config.environment === ENV_STAGE_MODE && (
            <>
                ...
                <CoreBox
                    styleClasses={[CoreClasses.PADDING.P2, CoreClasses.BG.BG_BLACK, CoreClasses.COLOR.TEXT_WHITE]}
                >
                    <ApiVersion />
                </CoreBox>
            </>
