...
CoreTabs.validProps = [
    ...
    types: [
      {
        ...
        type: "object",
        validValues: [
          `ScrollButtonComponent{ endScrollButtonIcon?: func| object, startScrollButtonIcon?: func| object }`,
        ],
      },
    ],
  },
    ...
    types: [
      {
        ...
        type: "object",
        validValues: [
          `scrollButtons{ EndScrollButtonIcon?: elementType, StartScrollButtonIcon?: elementType }`,
        ],
      },
    ],
  },
  {
    ...
    types: [{ default: "{}", type: "object", validValues: [object] }],
  },
  {
