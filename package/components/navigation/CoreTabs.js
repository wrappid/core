...
CoreTabs.validProps = [
  ...
  {
    description: "The components used for each slot inside.\nExmple object: scrollButtons{ EndScrollButtonIcon?: elementType, StartScrollButtonIcon?: elementType }",
    name       : "slots",
    types      : [
      {
        default: {},
