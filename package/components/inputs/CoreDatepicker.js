...
CoreDatePicker.validProps = [
  ...
  {
    description:
      "A label that describes the content of the date picker. e.g. \"Arrival date\".",
    name : "label",
  ...
  {
    description:
      "Callback fired when the selected sections change.Signature:function(newValue: FieldSelectedSections) => voidnewValue The new selected sections.",
    name : "onSelectedSectionsChange",
    types: [{ default: "-", type: "function" }],
  },
  {
    description:
      "Callback fired on view change.Signature:function(view: TView) => voidview The new view.",
    name : "onViewChange",
    types: [{ default: "-", type: "function" }],
  },
  {
    description:
      "Callback fired on year change.Signature:function(year: TDate) => voidyear The new year.",
    name : "onYearChange",
    types: [{ default: "-", type: "function" }],
  },
  {
  ...
  },
  {
    ...
    name : "openTo",
    types: [{ default: "-", defaultValue: ["day", "month", "year"], type: "string" }],
  },
  {
    description: "Force rendering in particular orientation.",
    name       : "orientation",
    types      : [{ default: "-", type: "landscape'| 'portrait'" }],
  },
  {
  ...
  {
    description:
      "Component displaying when passed loading true.Signature:function() => React.ReactNodeReturns: The node to render when loading.",
    name : "renderLoading",
    types: [{ type: "function" }],
  },
  {
    ...
    types: [
      {
        default: "-",
        type   : "all'| 'day'| 'empty'| 'hours'| 'meridiem'| 'minutes'| 'month'| 'seconds'| 'weekDay'| 'year'| number",
      },
    ],
  },
  {
    description:
      "Disable specific date.Warning: This function can be called multiple times (for example when rendering date calendar, checking if focus can be moved to a certain date, etc.). Expensive computations can impact performance.Signature:function(day: TDate) => booleanday The date to test.Returns: If true the date will be disabled.",
    name : "shouldDisableDate",
    types: [{ default: "-", type: "function" }],
  },
  {
    description:
      "Disable specific year.Signature:function(year: TDate) => booleanyear The year to test.Returns: If true, the year will be disabled.",
    name : "shouldDisableYear",
    types: [{ default: "-", type: "function" }],
  },
  {
    description:
      "If true, days outside the current month are rendered:- if fixedWeekNumber is defined, renders days to have the weeks requested.- if fixedWeekNumber is not defined, renders day to fill the first and last week of the current month.- ignored if calendars equals more than 1 on range pickers.",
  ...
  {
    description:
      "Overridable component slots.See Slots API below for more details.",
    name : "slots",
    types: [{ default: "{}", type: "object" }],
  },
  {
    ...
    name : "sx",
    types: [{ default: "-", type: "Array<function| object| boolean>| function| object" }],
  },
  {
  ...
  },
  {
    ...
    name : "view",
    types: [{ default: "-", type: "day'| 'month'| 'year'" }],
  },
];
