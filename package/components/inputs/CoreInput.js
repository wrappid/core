...
CoreInput.validProps = [
  ...
  {
    description: "The extra props for the slot components. You can override the existing props or add new ones.This prop is an alias for the componentsProps prop, which will be deprecated in the future.\n Example object: { input?: object, root?: object }",
    name       : "slotProps",
    types      : [{ default: {}, type: "object" }],
  },
  {
    description: "The components used for each slot inside.This prop is an alias for the components prop, which will be deprecated in the future. Example Object: { input?: elementType, root?: elementType }",
    name       : "slots",
    types      : [{ default: {}, type: "object" }],
  },
  {
