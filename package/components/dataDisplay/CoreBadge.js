...
CoreBadge.validProps = [
  {
    description: "The anchor of the badge.Example: { horizontal: [left, right], vertical: [bottom, top] }",
    name       : "anchorOrigin",
    types      : [
      {
  ...
  {
    description: "The extra props for the slot components. You can override the existing props or add new ones.This prop is an alias for the slotProps prop. It's recommended to use the slotProps prop instead, as componentsProps will be deprecated in the future.Example: { Root: elementType, badge: elementType }",
  ...
  {
    description: "The props used for each slot inside the Badge. {badge: function, root : function}",
    name       : "slotProps",
    types      : [
      {
        default: {},
  ...
  {
    description: "The components used for each slot inside the Badge. Either a string to use a HTML element or a component.Example: { badge: elementType, root: elementType }",
    name       : "slot",
    types      : [
      {
        default: {},
