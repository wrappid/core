...
CoreBadge.validProps = [
  {
    description: "The anchor of the badge.{ horizontal: [\"left\", \"right\"], vertical: [\"bottom\", \"top\"] } ",
    name       : "anchorOrigin",
    types      : [
      {
  ...
  {
    description: "The extra props for the slot components. You can override the existing props or add new ones.This prop is an alias for the slotProps prop. It's recommended to use the slotProps prop instead, as componentsProps will be deprecated in the future.Example Object:  { Root: \"elementType\", badge: \"elementType\" }",
