...
export default class DefaultCoreStyles extends BaseStyle {
  ...
  constructor() {
    ...
    this.style = {
      ...
      headerFooterLayoutFooter        : {},
      fixedHeaderLayoutHeader         : { ...this.defaultUtilityStyles.positionSticky },
      fixedHeaderLayoutContent        : { ...this.defaultUtilityStyles.positionSticky, ...this.defaultUtilityStyles.vh50, ...this.defaultUtilityStyles.displayFlex, ...this.defaultUtilityStyles.flexDirectionColumn },
      ...
      fixedHeaderFooterLayoutHeader   : { ...this.defaultUtilityStyles.positionSticky },
      fixedHeaderFooterLayoutContent  : { ...this.defaultUtilityStyles.positionSticky, ...this.defaultUtilityStyles.displayFlex, ...this.defaultUtilityStyles.flexDirectionColumn, ...this.defaultUtilityStyles.h100 },
      fixedHeaderFooterLayoutFooter   : { ...this.defaultUtilityStyles.positionSticky },
